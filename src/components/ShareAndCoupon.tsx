  ...
  return (
    <>
      ...
      <div className="animate-fade-up stagger-3 mb-10 rounded-2xl border border-line bg-sand/20 p-5 text-center sm:p-6">
        ...
        {/* Copy button (visible after share) */}
        {hasShared && (
          <div className="mt-3">
            <button
              onClick={handleCopy}
        ...
        {copyState === "fallback" && (
          <div className="mt-3">
            ...
            <textarea
              ...
              readOnly
              value={COUPON_CODE}
              className="mx-auto block w-40 resize-none rounded border border-line bg-surface p-2 text-center font-mono text-sm text-ink"
              rows={1}
            />
          </div>
        )}
